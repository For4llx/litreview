...
urlpatterns = [
    ...
    path('subscription/delete/<int:id>', reviews.views.subscription_delete, name='subscription_delete'),
    ...
    path('post/review/create/<int:id>', reviews.views.review_create, name='review_create'),
